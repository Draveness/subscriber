...
class CreatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create creator" do
    assert_difference('Creator.count') do
      post creators_url, params: { creator: { avatar: @creator.avatar, content: @creator.content, email: @creator.email, name: @creator.name, password_digest: @creator.password_digest } }, as: :json
    end
  ...
  test "should update creator" do
    patch creator_url(@creator), params: { creator: { avatar: @creator.avatar, content: @creator.content, email: @creator.email, name: @creator.name, password_digest: @creator.password_digest } }, as: :json
    assert_response 200
  end
